                ...
                <div class="container">
                    ...
                    <div class="menu-extras">
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            ...
                            <li class="dropdown navbar-c-items">
                                <a href="" class="dropdown-toggle waves-effect waves-light profile" data-toggle="dropdown" aria-expanded="true"><img src="template/images/users/avatar-1.jpg" alt="user-img" class="img-circle"> </a>
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li class="has-submenu">
                                <a href="/mahasiswa119"><i class="md md-dashboard"></i>Mahasiswa</a>
                            </li>
                        </ul>
                        <!-- End navigation menu        -->
                    </div>
